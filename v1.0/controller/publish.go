...
import (
	...
	util2 "github.com/goTouch/TicTok_SimpleVersion/v1.0/util"
	"io"
	"log"
	"net/http"
	"net/url"
...
func Publish(c *gin.Context) {
	...
	jpeg, err := util2.ReadFrameAsJpeg(presignedURL.String(), 1)

	if err == nil {
		buf := &bytes.Buffer{}
		buf.ReadFrom(jpeg)
		putSnapshotToOss(buf, util2.PictureBucketName, filename+".jpg")
...
func PublishList(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusOK, domain2.Response{StatusCode: 1, StatusMsg: "用户id解析错误"})
		return
	}
